...
class MyCylinder extends CGFobject {
    ...
    initBuffers() {
        ...
        for (var j = 0; j <= this.slices; j++) {
            this.vertices.push(this.top*Math.cos(j * 360 * DEGREE_TO_RAD / this.slices), 0, this.top*Math.sin(j * 360 * DEGREE_TO_RAD / this.slices));
            this.vertices.push(this.bottom*Math.cos(j * 360 * DEGREE_TO_RAD / this.slices), this.height,this.bottom* Math.sin(j * 360 * DEGREE_TO_RAD / this.slices));
        }
        /* INDICES */
