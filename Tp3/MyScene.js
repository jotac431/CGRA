...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 4, 2.5);
        this.cylinder = new MyCylinder(this, 4, 2.5, 1, 1);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.9, 0.4, 0.1, 1.0);
        this.material4.setDiffuse(0, 0, 0, 1.0);
        this.material4.setSpecular(0.9/4, 0.4/4, 0.1/4, 1.0);
